...
<!-- MEMO : participate in InnerSource の訳を見直す -->
...
InnerSource の成功の定量的な測定に焦点をあてる領域のトップ3は以下の通りです :
<!-- MEMO : まるまる訳を見直す -->

1. InnerSource プロジェクトの消費、または再利用の測定
<!-- MEMO : consumption の訳を改めて考える -->
